...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Circuit", b =>
                {
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Constructor", b =>
                {
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Driver", b =>
                {
            ...
            modelBuilder.Entity("JsonToDbTest.Models.DriverStanding", b =>
                {
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Race", b =>
                {
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Result", b =>
                {
                    b.Property<string>("DriverId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("JsonToDbTest.Models.DriverStanding", b =>
                {
                    b.HasOne("JsonToDbTest.Models.Constructor", "Constructor")
                        .WithMany("DriverStandings")
                        .HasForeignKey("ConstructorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JsonToDbTest.Models.Driver", "Driver")
                        .WithMany("DriverStandings")
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JsonToDbTest.Models.Season", "Season")
                        .WithMany("DriverStandings")
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Race", b =>
                {
                    b.HasOne("JsonToDbTest.Models.Circuit", "Circuit")
                        .WithMany("Races")
            ...
            modelBuilder.Entity("JsonToDbTest.Models.Result", b =>
                {
                    ...
                    b.HasOne("JsonToDbTest.Models.Race", "Race")
                        .WithMany("Results")
